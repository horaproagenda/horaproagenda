        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild onClick={(e) => e.stopPropagation()}>
            <Button 
              variant="ghost" 
              size="icon" 
              className="h-5 w-5 opacity-100 md:opacity-60 md:group-hover:opacity-100 transition-all duration-200"
            >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild onClick={(e) => e.stopPropagation()}>
              <Button 
                variant="ghost" 
                size="icon" 
                className="h-6 w-6 opacity-100 md:opacity-60 md:group-hover:opacity-100 transition-all duration-200"
              >
