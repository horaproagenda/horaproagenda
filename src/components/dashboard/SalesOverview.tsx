    ...
    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
      <Card className="border-l-4 border-l-emerald-500">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 p-3 pb-1">
          <CardTitle className="text-[11px] font-medium text-primary uppercase tracking-wide">Vendas Hoje</CardTitle>
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-primary/80/10">
            <DollarSign className="h-3 w-3 text-primary" />
          </div>
        </CardHeader>
        <CardContent className="p-3 pt-0">
          <div className="text-base font-bold text-primary tabular-nums">{formatCurrency(daily)}</div>
      ...
      <Card className="border-l-4 border-l-sky-500">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 p-3 pb-1">
          <CardTitle className="text-[11px] font-medium text-accent uppercase tracking-wide">Vendas do Mês</CardTitle>
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-accent/80/10">
            {isPositive ? (
        ...
        <CardContent className="p-3 pt-0">
          <div className="text-base font-bold text-accent tabular-nums">{formatCurrency(monthly)}</div>
          <p className={`text-[10px] flex items-center gap-1 mt-0.5 ${isPositive ? 'text-primary' : 'text-red-500'}`}>
      ...
      <Card className="border-l-4 border-l-violet-500">
        ...
        <CardContent className="p-3 pt-0">
          <div className="text-base font-bold text-accent tabular-nums">{formatCurrency(yearly)}</div>
