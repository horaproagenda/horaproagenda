    ...
    <TooltipProvider delayDuration={0}>
      ...
      <aside
        ...
        className={cn(
          ...
          "fixed inset-y-0 left-0 z-40 h-[100dvh] max-h-[100dvh] border-r border-sidebar-border bg-gradient-warm transition-all duration-300 ease-in-out pt-safe pb-safe pl-safe shadow-sm",
