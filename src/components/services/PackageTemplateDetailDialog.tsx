...
const packageSchema = z.object({
  ...
  // Para pacotes sequenciais, "duration" é a soma das etapas e pode ultrapassar 8h.
  // O limite por etapa/serviço continua sendo controlado pelo DurationSelect (max 480).
