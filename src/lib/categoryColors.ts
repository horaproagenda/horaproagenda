...
const categoryColors: Record<string, { bg: string; border: string; text: string; hex: string }> = {
  ...
  'Sobrancelhas': { bg: 'bg-accent/10', border: 'border-accent/30', text: 'text-accent', hex: '#a855f7' },
  'Capilar': { bg: 'bg-accent/10', border: 'border-accent/30', text: 'text-accent', hex: '#14b8a6' },
  'Outros': { bg: 'bg-primary/10', border: 'border-primary/30', text: 'text-primary', hex: '#22c55e' },
};
