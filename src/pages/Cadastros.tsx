...
export default function Cadastros() {
  ...
  return (
    <AppLayout title="Cadastros" subtitle="Gerencie salas e equipamentos">
      <PageTransition>
          ...
          <Card className="card-hover border-0 shadow-sm">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-xs mt-0.5">Espaços de atendimento</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between py-3 px-4 rounded-lg bg-muted/50">
                ...
                <Badge variant="secondary" className="text-xs">{activeRooms} ativas</Badge>
              </div>
              <ManageRoomsDialog>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-xs mt-0.5">Recursos disponíveis</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        {hasRole('admin') && (
          <p className="text-xs text-muted-foreground mt-6">
            O cadastro e a gestão de profissionais agora ficam restritos ao{' '}
            <Link to="/admin" className="underline text-primary">Painel do Administrador</Link>.
          </p>
        )}
      </PageTransition>
    </AppLayout>
