      ...
      <div className="space-y-4 page-enter">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-3">
          ...
          <TabsList className="inline-flex w-max min-w-full h-auto gap-1.5 bg-muted/50 p-1">
            {[
              { v: 'relatorio', label: 'Relatório', Icon: FileText, color: 'text-accent', active: 'data-[state=active]:bg-accent/15 data-[state=active]:text-accent data-[state=active]:border-accent/40' },
              ...
              { v: 'formas-pagamento', label: 'Pagamento', Icon: CreditCard, color: 'text-primary', active: 'data-[state=active]:bg-primary/15 data-[state=active]:text-primary data-[state=active]:border-primary/40' },
              ...
              { v: 'dashboard', label: 'Dashboard', Icon: BarChart3, color: 'text-accent', active: 'data-[state=active]:bg-accent/15 data-[state=active]:text-accent data-[state=active]:border-accent/40' },
