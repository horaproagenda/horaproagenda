...
const PERMISSIONS_CONFIG = [
  ...
  { key: 'can_share_financial_with_admin', label: 'Compartilhar contas com adm/recepção', category: 'financial' },
  ...
  { key: 'can_share_clients_with_admin', label: 'Compartilhar clientes com adm/recepção', category: 'clients' },
  ...
  { key: 'can_manage_own_products', label: 'Produtos próprios', category: 'products' },
  { key: 'can_manage_products', label: 'Produtos da clínica', category: 'products' },
  { key: 'can_share_documents_with_admin', label: 'Compartilhar documentos com adm/recepção', category: 'documents' },
  ...
  { key: 'can_share_services_with_admin', label: 'Compartilhar serviços e pacotes com adm/recepção', category: 'services' },
