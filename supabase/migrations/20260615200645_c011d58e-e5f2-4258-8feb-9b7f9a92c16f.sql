...
BEGIN
  ...
  VALUES (
    ...
    jsonb_build_object(
      ...
      'sale_ids', v_sale_ids,
      'appointment_ids_unlinked', v_appointment_ids,
  ...
  RETURN jsonb_build_object(
    ...
    'unlinkedAppointments', COALESCE(array_length(v_appointment_ids, 1), 0),
    'deletedSales', COALESCE(array_length(v_sale_ids, 1), 0)
  );
END;
$function$;

GRANT EXECUTE ON FUNCTION public.delete_completed_or_cancelled_client_package(uuid) TO authenticated;