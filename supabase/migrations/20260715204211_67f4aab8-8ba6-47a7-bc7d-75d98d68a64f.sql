...
BEGIN
  ...
  -- Suspende recalculos/reconstruções em cascata durante a limpeza para
  -- evitar que triggers de conflito de horário rejeitem a exclusão.
  ...
  -- Restaura flags e faz UMA reconstrução final do pacote de forma segura.
  ...
  IF v_package_id IS NOT NULL THEN
    ...
    EXCEPTION WHEN OTHERS THEN
      -- Não propaga; a exclusão já ocorreu.
      NULL;
    END;
  END IF;
